...
{ package Muldis::Rosetta::Engine::Example::Routines; # package
    use version 0.74; our $VERSION = qv('0.0.0');
    # Note: This given version applies to all of this file's packages.
} # package Muldis::Rosetta::Engine::Example::Routines
...
Muldis::Rosetta::Engine::Example::Routines -
Implementations of all core Muldis D system-defined routines

=head1 VERSION

This document describes Muldis::Rosetta::Engine::Example::Routines version
0.0.0 for Perl 5.

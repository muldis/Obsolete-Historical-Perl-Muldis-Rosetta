...
{ package Muldis::Rosetta::Engine::Example::Util; # package
    use version 0.74; our $VERSION = qv('0.0.0');
    # Note: This given version applies to all of this file's packages.
} # package Muldis::Rosetta::Engine::Example::Util
...
Muldis::Rosetta::Engine::Example::Util -
Common elements of Muldis D source code parsers/builders and more

=head1 VERSION

This document describes Muldis::Rosetta::Engine::Example::Util version
0.0.0 for Perl 5.

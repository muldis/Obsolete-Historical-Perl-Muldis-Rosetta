...
{ package Muldis::Rosetta::Engine::Example::PlainText; # package
    use version 0.74; our $VERSION = qv('0.0.0');
    # Note: This given version applies to all of this file's packages.
} # package Muldis::Rosetta::Engine::Example::PlainText
...
Muldis::Rosetta::Engine::Example::PlainText -
Parser and builder of Plain Text Muldis D source code

=head1 VERSION

This document describes Muldis::Rosetta::Engine::Example::PlainText version
0.0.0 for Perl 5.

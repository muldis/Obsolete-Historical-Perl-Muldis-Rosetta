...
{ package Muldis::Rosetta::Engine::Example::Storage; # package
    use version 0.74; our $VERSION = qv('0.0.0');
    # Note: This given version applies to all of this file's packages.
} # package Muldis::Rosetta::Engine::Example::Storage
...
Muldis::Rosetta::Engine::Example::Storage -
Virtual file system for coordinating depot access

=head1 VERSION

This document describes Muldis::Rosetta::Engine::Example::Storage version
0.0.0 for Perl 5.

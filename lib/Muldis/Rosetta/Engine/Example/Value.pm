...
{ package Muldis::Rosetta::Engine::Example::Value; # package
    use version 0.74; our $VERSION = qv('0.0.0');
    # Note: This given version applies to all of this file's packages.
} # package Muldis::Rosetta::Engine::Example::Value
...
Muldis::Rosetta::Engine::Example::Value -
Physical representations of all core data type values

=head1 VERSION

This document describes Muldis::Rosetta::Engine::Example::Value version
0.0.0 for Perl 5.
